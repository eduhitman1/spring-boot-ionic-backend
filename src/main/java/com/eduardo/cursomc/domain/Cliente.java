...
public class Cliente implements Serializable{
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)   // definição da estratégia de geração de numero no banco
    private Integer id;
	private String nome;
	
	@Column(unique=true)        // CHAVE UNIQUE NÃO PERMITE DADOS REPETIDOS
	...
	@ElementCollection                                 // COMO NÃO EXISTE CLASS TELEFONE
