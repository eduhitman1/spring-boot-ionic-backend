...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "edu.hitman01@outlook.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123")); // SENHA DE USUARIO
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "edu.hitman01.eh@gmail.com", "31628382740",
				TipoCliente.PESSOAFISICA, pe.encode("123")); // SENHA DE USUARIO
